...
//
//    public String saveQuiz(String quizText, Map<Integer, String> answerMap) {
//        String quizId = UUID.randomUUID().toString();
//        String redisKey = "quiz:" + quizId;
//
//        // 1. 퀴즈 텍스트는 hash에 저장 (순서는 의미없음)
...
//
//        // 2. 문제 번호와 정답은 별도의 List에 순서대로 저장
//        // 예: "1:b", "2:c", "3:a", ... 순서대로 저장됨
//        String answerListKey = redisKey + ":answers";
//        answerMap.entrySet().stream()
//                .sorted(Map.Entry.comparingByKey()) // 숫자 오름차순 정렬
